...
final instRepositoryProvider = Provider<InstRepository>((ref) {
  ...
  final remoteSource = InstitutionRemoteSource(dio);
  return InstRepositoryImpl(null, remoteSource);
});
...
final deptRepositoryProvider = Provider<DeptRepository>((ref) {
  final dio = ref.watch(dioProvider);
  final remoteSource = DepartmentRemoteSource(dio);
  return DeptRepositoryImpl(null, remoteSource);
});
