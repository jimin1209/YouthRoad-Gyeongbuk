    ...
    return _then(_value.copyWith(
      ...
      description: freezed == description
          ...
          : description // ignore: cast_nullable_to_non_nullable
              as String?,
      displayYn: freezed == displayYn
          ? _value.displayYn
          : displayYn // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$PolicyImpl implements _Policy {
  ...
  @override
  String toString() {
    return 'Policy(id: $id, policyName: $policyName, policyType: $policyType, region: $region, institutionName: $institutionName, departmentName: $departmentName, startDate: $startDate, endDate: $endDate, applyUrl: $applyUrl, description: $description, displayYn: $displayYn)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.displayYn, displayYn) ||
...
abstract class _Policy implements Policy {
  const factory _Policy(
      ...
      final String? applyUrl,
      final String? description,
      final String? displayYn}) = _$PolicyImpl;
